...
type WeatherResponse struct {
	...
	TempInfo string `protobuf:"bytes,2,opt,name=temp_info,json=tempInfo,proto3" json:"temp_info,omitempty"`
}
...
func (x *WeatherResponse) GetTempInfo() string {
	if x != nil {
		return x.TempInfo
	}
	return ""
...
var file_weather_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6d,
